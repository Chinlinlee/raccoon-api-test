...
(async ()=> {
    ...
    let retrieveInstanceURL = new URL(`${config.DICOMwebServer.wadoPrefix}/studies/${studyID}/series/${seriesID}/instances/${instanceID}`, config.DICOMwebServer.baseUrl);
    console.log(`do WADO-RS retrieve instance: ${retrieveInstanceURL.href}`);
    let retrieveResponse = await axios.get(retrieveInstanceURL.href, {
