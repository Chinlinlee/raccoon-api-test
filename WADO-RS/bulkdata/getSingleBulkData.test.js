...
(async ()=> {
    ...
    let bulkDataUrlPath =`${config.DICOMwebServer.wadoPrefix}/studies/${studyID}/series/${seriesID}/instances/${instanceID}/bulkdata/00480105.Value.0.00282000.InlineBinary`;
